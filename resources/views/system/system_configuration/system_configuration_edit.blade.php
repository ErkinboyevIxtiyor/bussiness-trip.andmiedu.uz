        ...
        <div>
            <div class="col-md-6">
                ...
                {{-- <div class="card card-outline card-primary shadow-none rounded-0 elevation-2"> 
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                      <form action="/system/configuration/section/update/{{$system_section_edit->id}}" method="post">
                        @csrf
                        <div class="form-group">
                            <label for="name" >Nomi</label>
                            <input type="text" class="form-control rounded-0 @error('name') border border-danger @enderror" name="name" id="name" value="{{$system_section_edit->name}}">
                          ...
                          <div class="d-flex justify-content-end">
                            <a href="/system/configuration" class="mr-1 btn btn-flat btn-light border border-1">Bekor</a>
