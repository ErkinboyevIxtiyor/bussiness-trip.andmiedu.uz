      ...
      <section class="container">
        <div class="card card-primary card-outline rounded-0">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <form action="/employee/employee-search" method="get" class="d-flex">
                              <input type="text" class=" form-control rounded-0" placeholder="Familiya / Pasport / Xodim ID bo‘yicha qidirish" name="search" value="{{$search}}">
                              {{-- <div class="ml-1">
            ...
            <div class="card-body">
                ...
                <div class="mt-3">
                  <span>Jami xodimlar soni: {{$employee_total}} ta</span>
                </div>
                {{-- <div class="mt-3">
                  {{$employee->links()}}
                  <span>{{$employee->firstItem()}} - {{$employee->lastItem()}} / jami  {{$employee->total()}} ta</span>
                </div> --}}
            </div>
        </div>
      </section>
